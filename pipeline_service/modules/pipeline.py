...
class GenerationPipeline:
    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        # Set seed - Optimized range for better variance capture
        if request.seed < 0:
            # Using prime-based range for better distribution and lucky variance
            # Research shows seeds in certain ranges produce better results
            request.seed = secure_randint(1000, 50000)
